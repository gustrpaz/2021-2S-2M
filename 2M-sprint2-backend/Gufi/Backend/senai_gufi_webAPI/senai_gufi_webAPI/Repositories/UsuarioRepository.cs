    ...
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public string ConsultarPerfilBD(int id_usuario)
        {
            ...
            if (imagemUsuario != null)
            {
                ...
                // Converte o valor de uma matriz de inteiros (array de binários) em string.
        ...
        public Usuario Login(string email, string senha)
        {
            ...
            //Instacia do objeto ImagemUsuario para gravar o arquivo no Banco de Dados
        ...
        public void SalvarPerfilDir(IFormFile foto, int id_usuario)
        {
            ...
            // Define o nome do arquivo com o ID do usuário
            string nome_novo = id_usuario.ToString() + ".png";

            // FileStream fornece a exibição para uma sequência de bytes.
            // dando suporte para leitura e gravação.
            using (var stream = new FileStream(Path.Combine("perfil", nome_novo),
                FileMode.Create))
            {

                // copia todos os arquivos para (array de bytes) para o caminho indicado.
                foto.CopyTo(stream);
            }
        }
    }
